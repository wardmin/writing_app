// FlipClock.SecondHandFace = FlipClock.MinuteCounterFace.extend({
...
// 		build: function() {
// 			this.base(true, this.factory.time.getSecondly());
// 		},
...
// 				time = this.factory.time.getSecondly();
...
(function($) {
	...
	FlipClock.SecondHandFace = FlipClock.Face.extend({
		...
		build: function(excludeHours, time) {
			...
			time     = time ? time : this.factory.time.getSecondly();
		...
		flip: function(time, doNotAddPlayClass) {
			...
			if (time[0] == 6) {
				$('.secondhand').fadeOut(2000, function() {
					this.remove();
				});
